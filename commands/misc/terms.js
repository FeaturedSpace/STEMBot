...
exports.exec = async (Bastion, message) => {
  await message.channel.send({
    embed: {
      ...
      title: 'STEMBot - Terms of Service',
      url: 'https://featuredspace.com/',
      description: '\nSTEMBot has access to the End User Data through the Discord API, but STEMBot does not collect, use and/or disclose End User Data except (a) as necessary to exercise your rights under this Agreement, (b) in accordance with Discord’s Privacy Policy.' +
